...
<reference>
@/home/yander/Projects/leettui/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/yander/Projects/leettui/.claude/gsd-core/references/user-profiling.md` to load:
