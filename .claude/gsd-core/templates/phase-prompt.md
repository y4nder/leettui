...
<!-- For checkpoint task examples and patterns, see @/home/yander/Projects/leettui/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/yander/Projects/leettui/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/yander/Projects/leettui/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/yander/Projects/leettui/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
