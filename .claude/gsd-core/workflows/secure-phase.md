...
```
Agent(
  prompt="Read /home/yander/Projects/leettui/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/yander/Projects/leettui/.claude/gsd-core/templates/SECURITY.md`
