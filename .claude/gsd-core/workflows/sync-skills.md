...
INSTALL_JS_GLOBAL="/home/yander/Projects/leettui/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/yander/Projects/leettui/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
