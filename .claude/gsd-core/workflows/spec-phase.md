...
ones). Reference: @/home/yander/Projects/leettui/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/yander/Projects/leettui/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/yander/Projects/leettui/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/yander/Projects/leettui/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/yander/Projects/leettui/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/yander/Projects/leettui/.claude/gsd-core/templates/spec.md.
