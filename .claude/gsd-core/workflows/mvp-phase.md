...
<required_reading>
@/home/yander/Projects/leettui/.claude/gsd-core/references/user-story-template.md
@/home/yander/Projects/leettui/.claude/gsd-core/references/spidr-splitting.md
@/home/yander/Projects/leettui/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/yander/Projects/leettui/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/yander/Projects/leettui/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/yander/Projects/leettui/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
