...
- **Global scope**: `/home/yander/Projects/leettui/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/yander/Projects/leettui/.claude/notes/`)
...
2. Glob `/home/yander/Projects/leettui/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/yander/Projects/leettui/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/yander/Projects/leettui/.claude/notes/` — works in any directory
