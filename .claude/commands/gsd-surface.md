...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/yander/Projects/leettui/.claude/.gsd-surface.json`
(sibling to `/home/yander/Projects/leettui/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/yander/Projects/leettui/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/yander/Projects/leettui/.claude/skills`).
...
`/home/yander/Projects/leettui/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/yander/Projects/leettui/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/yander/Projects/leettui/.claude/.gsd-surface.json`
Install profile marker: `/home/yander/Projects/leettui/.claude/.gsd-profile`
Skill dirs: `/home/yander/Projects/leettui/.claude/skills/gsd-*/`
Engine module: `/home/yander/Projects/leettui/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/yander/Projects/leettui/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
