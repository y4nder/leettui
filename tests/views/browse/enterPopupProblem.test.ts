...
mock.module("@/views/problem/handlers", () => ({
...
let handleEnterPopupProblem: typeof import("@/views/browse/handlers").handleEnterPopupProblem;
...
beforeAll(async () => {
  ...
  ({ handleEnterPopupProblem } = await import("@/views/browse/handlers"));
});
